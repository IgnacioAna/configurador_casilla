<!-- ARCHIVED — Milestone v1.0 (shipped 2026-06-28). Snapshot of REQUIREMENTS.md at milestone close.
     All 34 v1 requirements completos y verificados PASSED. Las próximas requirements del milestone v2
     se definen con /gsd-new-milestone (REQUIREMENTS.md fresco). -->

# Requirements: Configurador Visual de Casillas Rurales Impacar — v1.0 (ARCHIVED)
